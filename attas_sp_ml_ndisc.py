...
class Model(symfem.DiscretizedNoiseModel, symfem.ZOHDynamicsModel):
    pass


class Problem(fem.DiscretizedNoiseProblem, fem.ZOHDynamicsProblem):
    pass
...
if __name__ == '__main__':
    ...
    var0['sQc_tril'][symfem.tril_diag(2)] = 1e-3
    ...
    var_L['sQc_tril'][symfem.tril_diag(2)] = 0
    ...
    var_scale['Kn'][:] = 1e2
    var_scale['sQc_tril'][:] = 1e2
    
    with problem.ipopt(dec_bounds, constr_bounds) as nlp:
        nlp.add_str_option('linear_solver', 'ma57')
        nlp.add_num_option('ma57_pre_alloc', 50.0)
    ...
    sQc = symfem.tril_mat(opt['sQc_tril'])
